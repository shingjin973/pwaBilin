...
export class BundlesComponent implements OnInit {
    ...
    getData(page, search_key = this.currentFilter) {
        ...
        // this.data.getBundlesByPaginate(this.is_first_load, page, search_key).subscribe(async (res) => {
        //     if (res && res.data) {
        ...
        //     }
        // })
        this.data.getAllBundleEnrollmentsByPaginate(this.is_first_load, page, search_key).subscribe(async (res) => {
            if (res && res.data) {
                ...
                this._bundles = enrollments;
                this.bundles = enrollments;           
                if (this.is_first_load === 1) {
                    this.pager = res.pager;
                    this.is_first_load = 0;
                }
